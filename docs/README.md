...
> **Status:** Reference · **Verified:** 2026-09-26 · **Canonical for:** the docs map — where truth lives per subject · **Read this if:** you need to find the one file that owns a subject before reading or editing it.
...
| Direction | [`.project/PLAN.md`](../.project/PLAN.md) | Owner-approved 2026-09-25. Supersedes [`docs/TRUE-NORTH.md`](TRUE-NORTH.md) on **scope and sequencing**; TRUE-NORTH's honesty and accessibility principles still hold. Where a summary and its source disagree, the source wins. |
