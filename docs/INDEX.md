...
| [STATION-MAP.md](STATION-MAP.md) | Canonical map | The Station's logical deck plan: eight decks (Today, Systems, Projects, Journal, News, Interests, Backups, Settings), each named for its job, with its resident — or an icon (Settings). |
