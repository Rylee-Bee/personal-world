...
> **Status:** Historical · **Verified:** 2026-09-26 · **Canonical for:** nothing (see `.project/CURRENT.md`) · **Read this if:** you want the record of how the 0.1 development line got here. · **Superseded by:** `.project/CURRENT.md`

**In short:** a curated milestone record, newest first, from the 2026-09-06 bootstrap to the 2026-09-23 docs/CI/skills truth pass. It is history, not a description of today — for current truth read `.project/CURRENT.md` and the files it routes to.

Since the newest entry here: `.project/PLAN.md` (owner-approved 2026-09-25) superseded TRUE-NORTH's scope and sequencing, the **Bridge** became the home screen in the `ui/` app, rooms arrived as the core architecture (runtime registry, per-person forwarding), and production runs on the transcode host.
