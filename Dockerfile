...
# The Station is the product frontend and ships as static files (COPY'd
# above); /login and /setup are server-rendered. The superseded React SPA
# and its build stage were removed 2026-09-16 (single-branch cutover).
