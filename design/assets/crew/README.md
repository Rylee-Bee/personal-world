...
| `assistant/` | **The Assistant** (2026-09-26), the plain default companion: `assistant-portrait` (porthole bust, 1024², framed like the crew portraits), `assistant-listening` (bust, beside Chat), `assistant-hello` (full monitor, 1024×1536; it carries a soft baked-in glow, so use it on dark panels, not as a strict cutout), and the original `assistant.svg` (vector fallback). |
