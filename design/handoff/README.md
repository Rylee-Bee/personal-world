...
The original Personal World 0.1 design handoff (GitHub
`Rylee-Bee/personal-world`; this URL was renamed from the
historical `burgeswe/personal-world` on 2026-09-11; the old URL
still redirects) commit `aa3f6d8`, 2026-09-06. Preserved verbatim
as historical/reference material; commit IDs predate the
2026-09-07 history sanitization and were remapped to their
rewritten equivalents.
